...
int MINIMUM_UP_ANGLE = 30;
int MINIMUM_DOWN_ANGLE = -150;
...
{  
    ...
    int up_down_flag = 0;
    if(angle_thumb>MINIMUM_UP_ANGLE && angle_thumb<(180-MINIMUM_UP_ANGLE)) up_down_flag = 1;
    else if(angle_thumb>MINIMUM_DOWN_ANGLE && angle_thumb<(-180-MINIMUM_DOWN_ANGLE)) up_down_flag = -1;
